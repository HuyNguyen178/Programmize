    ...
    <div class="container-fluid">
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body">
                ...
                <%-- FILTER BAR --%>
                <form class="row g-3 align-items-center mb-4" method="GET" action="class-students">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <c:choose>
                                            <c:when test="${student.status}">
                                                <a href="class-students?action=toggleStatus&id=${student.id}&newStatus=0&classId=${classId}&search=${search}&status=${status}&pageIndex=${pageIndex}"
                                            ...
                                            <c:otherwise>
                                                <a href="class-students?action=toggleStatus&id=${student.id}&newStatus=1&classId=${classId}&search=${search}&status=${status}&pageIndex=${pageIndex}"
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-end mt-4">
                            ...
                            <li class="page-item ${pageIndex == 1 ? 'disabled' : ''}">
                                <a class="page-link" href="class-students?pageIndex=${pageIndex - 1}&classId=${classId}&search=${search}&status=${status}">Previous</a>
                            </li>
                            ...
                            <c:forEach begin="${startPage}" end="${endPage}" var="i">
                                <li class="page-item ${i == pageIndex ? 'active' : ''}">
                                    <a class="page-link" href="class-students?pageIndex=${i}&classId=${classId}&search=${search}&status=${status}">${i}</a>
                                </li>
                            </c:forEach>

                                <%-- Nút Next --%>
                            <li class="page-item ${pageIndex == totalPage ? 'disabled' : ''}">
                                <a class="page-link" href="class-students?pageIndex=${pageIndex + 1}&classId=${classId}&search=${search}&status=${status}">Next</a>
                            </li>
                        </ul>
                    </nav>
                </c:if>
