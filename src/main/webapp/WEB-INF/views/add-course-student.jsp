...
<div id="content" class="p-4">
    <div class="container-fluid p-0">
        ...
        <div class="d-flex justify-content-between align-items-center page-header">
            <h2 class="text-primary fw-bold"><i class="fas fa-user-plus me-2"></i> Add Student to Course</h2>
        </div>
        ...
        <%
            ...
            List<String> courseNamesList = (List<String>) request.getAttribute("courseNamesList");
        %>
        ...
        <div class="card shadow-lg">
            <div class="card-body p-4">
                ...
                <form method="post" action="add-course-student" class="row g-3">
                    ...
                    <div class="col-md-6 ps-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="courseName" name="courses" required multiple style="min-height: 150px;">
                                <%
                                    String targetCourseName = (String) request.getAttribute("targetCourseName");

                                    if (courseNamesList != null && !courseNamesList.isEmpty()) {
                                        for (String name : courseNamesList) {
                                            String selected = (targetCourseName != null && targetCourseName.equals(name)) ? "selected" : "";
                                %>
                    ...
                    <div class="col-12 pt-3 border-top">
                        <div class="d-flex justify-content-between">
                            <a href="course-students?courseId=${param.courseId}" class="btn btn-secondary">
