...
<div id="content" class="content-wrapper">
    <div class="container-fluid-custom p-0">
        ...
        <form action="${pageContext.request.contextPath}/edit-lesson" method="post" enctype="multipart/form-data" class="p-4 bg-white rounded shadow-lg">
...
<%--                        <small class="text-muted">e.g., 300 = 5 minutes</small>--%>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="hidden" id="description" name="content" value="${lesson.content}">
...
<script>
    ...
    const form = document.querySelector('form[action$="/edit-lesson"]');
