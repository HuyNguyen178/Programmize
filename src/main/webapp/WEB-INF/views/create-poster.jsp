...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/create-poster.css">
</head>
<body>
...
<div class="page-header">
    <div class="container">
        <h1><i class="fas fa-pen-to-square"></i> Create New Post</h1>
        <p>Share your knowledge and experience with the community</p>
    </div>
</div>
...
<div class="container create-post-container">
    ...
    <form id="createPostForm" action="blog/create-poster" method="post" enctype="multipart/form-data">
        ...
        <div class="form-card">
            ...
            <input type="file" id="fileInput" name="thumbnail" accept="image/png,image/jpeg,image/jpg,image/webp">
